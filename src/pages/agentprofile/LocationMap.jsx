    ...
    <div className=" flex gap-8">
      ...
      <div className="flex-1">
        <div className="flex  flex-col gap-2 mb-2">
          ...
          <h1 className="text-xl font-bold text-primary">Land Dimension map</h1>
        </div>

        <p className="text-sm text-[#575F6E] mb-2">
      ...
      <div className="flex gap-2 mb-6 overflow-x-auto pb-2">
        ...
        <Button variant="outline" size p-6 ="sm" className="gap-2 whitespace-nowrap">
          🏨 Hotels
        </Button>
        <Button variant="outline" size="sm" className="gap-2 whitespace-nowrap">
          🎯 Things to do
        ...
        <Card className="relative mb-6">
          ...
          <div className="absolute top-4 left-1/2 -translate-x-1/2 z-10">
            <div className="flex items-center bg-white rounded-full shadow-2xl px-4 py-2 gap-2">
              <MapPin className="h-5 w-5 text-gray-400" />
              <input
                type="text"
                placeholder="Enter your Address"
                className="bg-transparent text-primary border-none focus:outline-none w-64 placeholder:text-primary placeholder:text-base placeholder:pl-3"
              />
            </div>
          </div>
